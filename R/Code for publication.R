...
files <- list.files(
                    #path = "/home/allan/Bureau/Documents/Ergebnisse/87 - TOF-SIMS NOM/Rawdata for publication (S11 renamed S10)"
                    path = "G:\\23.03.2020\\Ergebnisse\\87 - TOF-SIMS NOM\\Rawdata for publication (S11 renamed S10)"
                    , pattern = ".*TXT")
...
Data <- lapply(files, function(y) {
  fread(
    file = paste0(
                  #"/home/allan/Bureau/Documents/Ergebnisse/87 - TOF-SIMS NOM/Rawdata for publication (S11 renamed S10)/"
                  "G:\\23.03.2020\\Ergebnisse\\87 - TOF-SIMS NOM\\Rawdata for publication (S11 renamed S10)\\"
                  , y),
    drop = c("m/z", "V200")
  )
})
